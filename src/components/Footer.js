          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="transform hover:scale-105 transition-transform duration-300">
              ...
              <ul className="space-y-4">
                ...
                <li><a href="#" className="hover:text-[#EC5E2A] transition-colors duration-300 flex items-center"><span className="mr-2">→</span>Services</a></li>
                <li><a href="#" className="hover:text-[#EC5E2A] transition-colors duration-300 flex items-center"><span className="mr-2">→</span>Contact</a></li>
              </ul>
            </div>
            <div className="transform hover:scale-105 transition-transform duration-300">
